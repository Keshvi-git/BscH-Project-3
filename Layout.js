...
function ProfitLossPage() {
    ...
    const fetchProfitLossData = () => {
        fetch("http://localhost:5000/transactions/profit-loss/date-wise?startDate=${startDate}&endDate=${endDate}")
            .then((res) => res.json())
        ...
        return (
            <div>
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="btn btn-success">Get Profit/Loss</button>
                </form>
            </div>
        );
    }
